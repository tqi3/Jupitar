...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "w8mwRZs0kFAg0CzrlxRPaZNidtjQTA6A";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//BufferedReader quickens reading
			//InputStream is the response content after the http request returns
